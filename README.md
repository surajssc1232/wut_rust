...
-   **Code Display:** Beautiful syntax highlighting for 100+ programming languages using the integrated `bat` crate.
-   **Enhanced AI Responses:** All code generated by AI is automatically syntax highlighted with proper colors and formatting.
...
-   **Bat (Optional but Recommended):** For enhanced syntax highlighting in AI responses and the display functionality, Huh uses the `bat` command-line tool. While not strictly required (Huh will fall back to plain text), installing `bat` greatly improves the visual experience:
    ...
    # On other systems, see: https://github.com/sharkdp/bat#installation
    ```
...
### Code Display
Display code files with beautiful syntax highlighting using the integrated `bat` crate:
...
$ huh -d src/main.rs src/lib.rs config.json
```

This feature provides:
- **Syntax highlighting** for 100+ programming languages
- **Line numbers** and file headers
- **Grid layout** with proper formatting
- **True color support** for modern terminals

### Enhanced AI Responses
All code generated by AI (in any mode) is automatically syntax highlighted using `bat`, providing beautiful colored output for:
...
Example AI response with syntax highlighting:
```bash
$ huh "write hello world in java"
```
Will display the Java code with proper keyword highlighting, colored strings, comments, and more.
